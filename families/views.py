...
#     return render(request, 'site/family_directory.html', {
#         'page_obj': page_obj,
#         'search': search,
#         'village': village,
#         'gotra': gotra,
...
#     return render(request, 'site/family_detail.html', {
#         'family': family,
#         'members': members,
#         'is_owner': is_owner,
#     })
...
#     family = get_object_or_404(Family, pk=pk, is_active=True)
#     members = family.members.filter(is_active=True).order_by('relation')
#     return render(request, 'site/family_pdf.html', {'family': family, 'members': members})


# def contact_page(request):
#     contact = ContactInfo.objects.first()
#     return render(request, 'site/contact.html', {'contact': contact})
...
#     return render(request, 'site/my_family.html', {'families': families})
...
#     return render(request, 'site/my_family_register.html', {'form': form})
...
#     return render(request, 'site/my_family_edit.html', {'form': form, 'family': family})
...
#     return render(request, 'site/my_family_members.html', {
#         'family': family,
#         'members': members,
#         'form': form,
#     })
