...
CLOUDINARY_STORAGE = {
    'CLOUD_NAME': os.environ.get('CLOUDINARY_CLOUD_NAME', 'community'),
    'API_KEY': os.environ.get('CLOUDINARY_API_KEY', '866558299657642'),
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/var/task/templates', BASE_DIR / 'templates'],
        'APP_DIRS': False,
        'OPTIONS': {
            'loaders': [
